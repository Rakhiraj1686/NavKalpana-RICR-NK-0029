    ...
    <div className="min-h-screen bg-linear-to-br from-[#020617] to-[#0f172a] text-white relative overflow-hidden ">
      ...
      <section className="relative z-10 pt-28 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-300 max-w-3xl mx-auto leading-relaxed text-lg">
            HealthUP is a modern fitness and wellness platform built to help individuals
            transform their health through structure, data-driven insights, and
            adaptive guidance. We combine smart tracking, personalized planning,
            and intelligent adjustments to help users stay consistent and
            achieve sustainable results — without confusion or burnout.
          </p>
        </div>
      </section>
      ...
      <section className="relative z-10 py-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              HealthUP was created to solve this gap — by providing a
              structured system that evolves with the user. Instead of
              one-size-fits-all templates, the platform monitors progress,
              detects patterns, and guides users intelligently.
            </p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-xl">
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              HealthUP focuses on long-term transformation rather than short-term hype.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-lg">
              ...
              <p className="text-gray-400">
                Track workouts, diet adherence, progress trends, and body metrics
                in one integrated dashboard for complete visibility.
              </p>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-lg">
              ...
              <p className="text-gray-400">
                The system adapts routines when progress slows, fatigue increases,
                or consistency drops — helping users avoid plateaus.
              </p>
            </div>
      ...
      <section className="relative z-10 py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            {["Create Profile", "Get Structured Plan", "Track Progress", "System Adapts"].map(
              (step, index) => (
                <div
                  key={index}
      ...
      <section className="relative z-10 py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            advanced analytics, and cloud deployment — ensuring reliability
      ...
      <section className="relative z-10 py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-300 max-w-3xl mx-auto leading-relaxed">
            We aim to evolve HealthUP into a complete digital wellness
            ecosystem — integrating intelligent coaching, predictive
            analytics, community support, and advanced health insights.
            Our mission is to empower individuals with clarity, structure,
            and confidence in their fitness journey.
          </p>
        </div>
      </section>
      ...
      <section className="relative z-10 py-24 px-6 text-center">
        <div className="max-w-6xl mx-auto">
          ...
          <button className="bg-linear-to-r from-purple-500 to-blue-500 px-10 py-4 rounded-xl font-semibold hover:scale-105 transition shadow-lg">
            Get Started
          </button>
        </div>
      </section>
