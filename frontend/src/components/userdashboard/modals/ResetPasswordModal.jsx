        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex gap-3 pt-4">
            <button
              type="button"
              onClick={onClose}
              className="w-1/2 bg-gray-600 py-2 rounded-xl hover:bg-gray-700 transition"
            >
              Cancel
            </button>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-1/2 bg-linear-to-r from-purple-500 to-blue-500 py-2 rounded-xl hover:scale-105 transition disabled:opacity-50"
            >
